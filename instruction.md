...
| `players` | Tuple[`Player`] | Tuple (liste non mutable) des instances `Player` représentants les joueurs de la partie.           | Non | - |
| `observers` | Tuple[`Player`] | Tuple (liste non mutable) des instances `Player` représentants les observateurs de la partie.      | Non | - |
...
Una clase de cliente para que los administradores de grupo gestionen los juegos dentro de un `GameGroup` específico.

*   **`group_name`** (`str`): El nombre del grupo a gestionar.
